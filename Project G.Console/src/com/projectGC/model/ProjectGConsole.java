...
public class ProjectGConsole {
    ...
    public ProjectGConsole(String consoleName,int quantity,String brand,String releaseDate){
        ...
        this.releaseDate= releaseDate;
            ...
            public ProjectGConsole(String consoleName, String brand, String technicalFeature, String additionalFeature, String energyEfficiency, String releaseDate, int price) {
        this.consoleName = consoleName;
        this.brand = brand;
