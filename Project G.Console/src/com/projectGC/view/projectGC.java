...
import com.projectGC.controller.algorithm.SelectionSort;
...
public class projectGC extends javax.swing.JFrame {
    ...
    private SelectionSortByName selectionSortByName = new SelectionSortByName();
    ...
    private void bntDeviceDetailsSortByActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntDeviceDetailsSortByActionPerformed
        ...
        if (SelectedComboBox == 1) {
            List<ProjectGConsole> sortedList = mergeSort.sortByPrice(consoleDeviceDetailsList, false);
